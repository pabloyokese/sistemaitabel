<body>
	...
	echo "MODIFICAR ADMINISTRADOR";
		...
		<?php echo form_open('principal/modificacion_administrador');?>
			...
			<table class="table table-bordered">
				<tr>
					...
					<tr><td>Password:</td><td><input type="text" name="password" value='<?php echo $administrador->password;?>'/></td></tr>
					...
					<tr><td>Telefono:</td><td><input type="text" name="cetelefono" value='<?php echo $persona->cetelefono;?>'/></td></tr>
