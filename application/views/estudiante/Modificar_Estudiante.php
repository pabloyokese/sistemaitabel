...
<body>
		...
		<?php
		echo "MODIFICAR ESTUDIANTE";
		?>

					<?php echo form_open('principal/modificacion_estudiante');?>
					...
					<table class="table table-bordered">
						<tr>
							...
							<tr>
								<td>Password:</td><td><input type="text" name="password" value='<?php echo $estudiante->password;?>'/></td></tr>
